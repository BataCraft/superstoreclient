...
const ProductDetails = ({ params }) => {
    ...
    const getStockStatus = (quantity_in_stock) => {
        if (quantity_in_stock <= 0) return { text: "Out of stock", color: "bg-red-100 text-red-800" };
        if (quantity_in_stock <= 20) return { text: "Low stock", color: "bg-yellow-100 text-yellow-800" };
        if (quantity_in_stock <= 50) return { text: "Medium stock", color: "bg-orange-100 text-orange-800" };
    ...
    const handleQuantity = (action) => {
        if (action === 'add' && quantity < product.quantity_in_stock) {
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    <StarReview stars={product.rating} />
